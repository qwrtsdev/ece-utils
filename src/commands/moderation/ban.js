    ...
    async execute(interaction) {
        try {
            ...
            if (!target.kickable) {
                return await interaction.reply({
                    content:
                        "🚫 ไม่สามารถแบนผู้ใช้นี้ออกได้ (บทบาทสูงกว่าหรือเป็นเจ้าของเซิร์ฟเวอร์)",
                    flags: MessageFlags.Ephemeral,
                });
            }
