...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            const userInfo = await eceMembers.findOne({ userID: interaction.user.id });
                        ...
                        .addSectionComponents(
                            new SectionBuilder()
                                ...
                                .addTextDisplayComponents(
                                    new TextDisplayBuilder().setContent("❌ กรุณาตั้งค่าโปรไฟล์ก่อนดำเนินการ"),
                                ),
                        ),
                ];
